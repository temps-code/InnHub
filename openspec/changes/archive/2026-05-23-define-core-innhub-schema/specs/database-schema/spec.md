...
- AND it SHOULD include `created_at` and `updated_at` unless design documents a justified exception
...
- AND the schema MUST enforce or prepare uniqueness of room identifiers per property
